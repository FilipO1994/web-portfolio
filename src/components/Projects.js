						...
						<Tab.Container id="projects-tabs" defaultActiveKey="first">
							...
							<Tab.Content id="slideInUp">
								...
								<Tab.Pane eventKey="third">
									...
									<p>
										"Tasty Delivery" is a delectable application crafted with finesse using Vite, designed to facilitate
										the seamless ordering of food with delivery straight to your designated address. Beyond its
										intuitive interface, the project boasts a meticulously engineered backend, dedicated to recording
										and managing all orders with precision and efficiency. Elevating the visual feast, every graphic
										within this project has been meticulously curated, with each image meticulously generated by
										artificial intelligence, adding a touch of innovation to every aspect of the dining experience.
									</p>
								</Tab.Pane>
							</Tab.Content>
						</Tab.Container>
